export { initLanguageBar, setActiveLanguage, hideLanguageBar, updateLanguageAvailability } from './LanguageBar';
...
export { initStatusBar, setStatus, setViewMode } from './StatusBar';
