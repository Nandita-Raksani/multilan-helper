...
function generateTraModule() {
  ...
  console.log('Generating tra-bundle.ts (folder-keyed)...');
  console.log(`Found translation folders: ${subdirs.join(', ') || '(none)'}`);

  let moduleContent = '// Auto-generated file - DO NOT EDIT\n';
  moduleContent += '// Generated by scripts/convert-tra-files.js\n\n';
  moduleContent += '// Each folder is wrapped in a function for lazy evaluation.\n';
  moduleContent += '// Data is only materialized when the folder is accessed,\n';
  moduleContent += '// reducing initial parse time and memory for unused folders.\n';
  moduleContent += 'export const traFileContents: Record<string, () => Record<string, string>> = {\n';
